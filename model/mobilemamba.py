...
if __name__ == "__main__":
    ...
    parser.add_argument('-i', '--imagesize', type=int, default=192)
    parser.add_argument('-m', '--modelname', default="MobileMamba_T4")
    ...
    with torch.no_grad():
        ...
        if gpu_id > -1:
            ...
            net.cuda()
            pre_cnt, cnt = 50, 20
        FLOPs.fvcore_flop_count(net, torch.randn(3, 3, img_size, img_size).cuda(), show_arch=False)
