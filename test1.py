...
def main(config):
    ...
    model = FIQAModel.MobileNetV3_Conv_Mamba_all()
    ...
    with torch.no_grad():
        ...
        for i, (video, name) in enumerate(test_loader):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--Model_weights_path', type=str, default='MobileNetV3_Conv_Mamba_all.pt', help='模型权重路径')
